...
class VirtualTourScreenII extends StatefulWidget {
  const VirtualTourScreenII({super.key});

  @override
  State<VirtualTourScreenII> createState() => _VirtualTourScreenIIState();
}

class _VirtualTourScreenIIState extends State<VirtualTourScreenII> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              context.push("/campus-location-II");
            },
