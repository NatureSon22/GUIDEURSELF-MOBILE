...
class CampusLocationScreenII extends StatefulWidget {
  const CampusLocationScreenII({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CampusLocationScreenIIState createState() => _CampusLocationScreenIIState();
}

class _CampusLocationScreenIIState extends State<CampusLocationScreenII> {
