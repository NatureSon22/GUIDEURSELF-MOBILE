...
class PrivacyLegalII extends StatefulWidget {
  const PrivacyLegalII({super.key});

  @override
  State<PrivacyLegalII> createState() => _PrivacyLegalIIState();
}

class _PrivacyLegalIIState extends State<PrivacyLegalII> {
